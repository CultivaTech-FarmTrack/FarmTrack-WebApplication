...
.buttons  {
  ...
  padding: 0.75rem 1.5rem; /* padding más generoso para un mejor toque visual */
...
.form .input {
  ...
  transition: border-color 0.3s, box-shadow 0.3s; /* Transiciones suaves para interacciones */
}

.form .input:focus {
  border-color: #337e21; /* Cambio de color en foco para mejor visibilidad */
  box-shadow: inset 0 2px 8px rgba(0,0,0,0.2), 0 0 8px rgba(51,126,33,0.6); /* Sombra más prominente en foco */
  outline: none; /* Elimina el contorno predeterminado para personalizar */
}
